...
docker run --rm --net cybercx-drupal-base_default amazeeio/dockerize dockerize -wait tcp://mariadb:3306 -timeout 1m
```
...
docker ps --filter label=com.docker.compose.project=cybercx-drupal-base | grep Up | grep cybercx-drupal-base-nginx-1
docker ps --filter label=com.docker.compose.project=cybercx-drupal-base | grep Up | grep cybercx-drupal-base-mariadb-1
docker ps --filter label=com.docker.compose.project=cybercx-drupal-base | grep Up | grep cybercx-drupal-base-php-1
docker ps --filter label=com.docker.compose.project=cybercx-drupal-base | grep Up | grep cybercx-drupal-base-cli-1

# Should ssh against the cli container by default
docker compose exec -T cli bash -c "env | grep LAGOON=" | grep cli-drupal

# Should have the correct environment set
docker compose exec -T cli bash -c "env" | grep LAGOON_ROUTE | grep cybercx-drupal-base.docker.amazee.io
